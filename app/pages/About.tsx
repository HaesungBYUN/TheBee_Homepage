...
export const meta: Route.MetaFunction = () => [
  ...
  { name: "description", content: "더비소프트의 멈추지 않는 성장의 기록과 핵심 가치를 확인해 보십시요." },
];
...
function Container1({ text, text1, isMounted }: Container1Props) {
  return (
    <Wrapper>
      <motion.div
      ...
      <BackgroundBorder isMounted={isMounted} additionalClassNames="left-[11.5px] sm:left-auto sm:right-[-8.5px] top-[8px]" />
    </Wrapper>
  );
}
...
function BackgroundBorder({ additionalClassNames = "", isMounted }: BackgroundBorderProps) {
  return (
    <motion.div
            ...
            >
              ...
              <div className="bg-white content-stretch flex flex-col gap-[32px] items-center py-[80px] lg:py-[120px] px-[24px] relative shrink-0 w-full">
                ...
                <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0 w-full lg:w-[900px]">
                  <motion.div
                    initial={isMounted ? { scaleY: 0 } : false}
                  ...
                  <div className="content-stretch flex items-start relative shrink-0 w-full">
                    ...
                    <Container4>
                      ...
                      <BackgroundBorder isMounted={isMounted} additionalClassNames="left-[11.5px] sm:left-[-8.5px] top-[9px]" />
                    </Container4>
                  </div>
                  ...
                  <div className="content-stretch flex items-start relative shrink-0 w-full">
                    <Wrapper>
                      ...
                      <BackgroundBorder isMounted={isMounted} additionalClassNames="left-[11.5px] sm:left-auto sm:right-[-8.5px] top-[9px]" />
                    </Wrapper>
                    <div className="flex-[1_0_0] h-[60px] min-h-px min-w-px relative hidden sm:block">
                      <div className="size-full" />
                    </div>
                  ...
                  <div className="content-stretch flex items-start relative shrink-0 w-full">
                    <Container1 isMounted={isMounted} text="2020" text1="LG CNS Oracle ERP 재무영역 도급 운영사 재선정" />
                    <div className="flex-[1_0_0] h-[60px] min-h-px min-w-px relative hidden sm:block">
                      <div className="flex flex-col items-end size-full">
                        <div className="size-full" />
                      </div>
                  ...
                  <div className="content-stretch flex items-start relative shrink-0 w-full">
                    <Container1 isMounted={isMounted} text="2013" text1="LG CNS ORACLE ERP 전문 협력사 등록" />
                    <div className="flex-[1_0_0] h-[60px] min-h-px min-w-px relative hidden sm:block">
                      <div className="flex flex-col items-end size-full">
                        <div className="size-full" />
                      </div>
